...
const getOrCreateHostingConfig = async (): Promise<HostingConfig | null> => {
...
const uploadImageToHosting = async({hosting, url, projectId, label}: StoreHostedImageParams): Promise<HostedAsset | null> => {
...
export{getOrCreateHostingConfig, uploadImageToHosting}
